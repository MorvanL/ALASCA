package fr.upmc.autonomicController.tests;
...
public class TestAutonomicControllerMonoJVM
extends		AbstractCVM
{
	// ------------------------------------------------------------------------
	...
	// for Computers 
	/** variables for test																		*/
	public static final int		NUMBER_OF_COMPUTERS = 3 ;
	...
	public				TestAutonomicControllerMonoJVM()
	throws Exception
	{
		super();
	}
	...
	public void			testScenario() throws Exception
	{
		for (int i = 0 ; i < NUMBER_OF_APPLICATIONS ; i++) {
			...
			// submission of the application to the datacenter
	...
	public static void	main(String[] args)
	{
		...
		try {
			final TestAutonomicControllerMonoJVM trcm = new TestAutonomicControllerMonoJVM() ;
